...
// Converts the integer 'number' into a 'width'-width, 'base' character
// representation in the string 'dest'.
...
// Converts the unsigned integer 'number' into a 'width'-width,
...
unsigned long long roy_ullong_invert(long long * number,
                                     int         position,
                                     size_t      count);
...
unsigned long long roy_ullong_rotate_left(unsigned long long * number,
                                          int                  steps,
                                          size_t               width); 
