...
#define roy_queue_front(queue, type_name) \
        (type_name)(roy_queue_empty(queue) ? NULL : (roy_array_pointer(ROY_ARRAY((queue)), (queue)->front_index)))
...
RoyQueue roy_queue_push(RoyQueue queue, const RoyElement data);
