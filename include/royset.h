...
RoySet roy_set_insert(RoySet * set, const RoyElement key, size_t key_size, RoyCompare comp);

// Removes the element equals to 'key' from 'set'.
RoySet roy_set_erase(RoySet * set, const RoyElement key, size_t key_size, RoyCompare comp);
