...
// Returns a pointer to a newly build RoySList's head for navigating,
...
// (Always call this function after the work is done by the given 'slist',
...
RoySList * roy_slist_push_front(RoySList   * slist,
                                const void * data,
                                size_t       element_size);

// Adds an 'element_size'-sized element named 'data' at the end of 'slist'.
RoySList * roy_slist_push_back(RoySList   * slist,
                               const void * data,
                               size_t       element_size);
