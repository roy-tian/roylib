...
RoyMSet roy_mset_insert(RoyMSet * mset, const RoyElement key, size_t key_size, RoyCompare comp);

// Removes the element equals to 'key' from 'mset'.
RoyMSet roy_mset_erase(RoyMSet * mset, const RoyElement key, size_t key_size, RoyCompare comp);
...
size_t roy_mset_count(const RoyMSet mset, const RoyElement key, RoyCompare comp);

RoyMSet roy_mset_lower_bound(const RoyMSet mset, const RoyElement key, RoyCompare comp);

RoyMSet roy_mset_upper_bound(const RoyMSet mset, const RoyElement key, RoyCompare comp);
