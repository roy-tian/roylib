...
RoyString roy_string_new_with_content(RoyStrLiteral str);

RoyString roy_string_assign(RoyString string, RoyStrLiteral str);
...
RoyStrLiteral roy_string_cstr(const RoyString string);
...
RoyString roy_string_insert_str(RoyString string, RoyStrLiteral substr, int index);
...
RoyString roy_string_append_str(RoyString string, RoyStrLiteral substr);

RoyString roy_string_append(RoyString string, const RoyString substring);

RoyString roy_string_replace_str(RoyString string, RoyStrLiteral substr, int index, size_t count);
...
int roy_string_find_str(RoyString string, RoyStrLiteral substr, int index);

int roy_string_find(RoyString string, const RoyString substr, int index);

int roy_string_find_regex(RoyString string, RoyStrLiteral regex, int index);

bool roy_string_match(RoyString string, RoyStrLiteral regex);
