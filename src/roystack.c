...
static void swap_elements(RoyElement data1, RoyElement data2, size_t size);
...
RoyStack
roy_stack_push(RoyStack stack, const RoyElement data) {
...
static void
swap_elements(RoyElement data1,
              RoyElement data2,
              size_t size) {
  char temp[size];
